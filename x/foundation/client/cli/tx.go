...
{
  "@type": "/cosmos.foundation.v1beta1.ThresholdDecisionPolicy",
  "threshold": "10",
  "windows": {
    "voting_period": "24h",
...
[
  {
    "@type": "/cosmos.foundation.v1beta1.MsgWithdrawFromTreasury",
    "operator": "addr1",
    "to": "addr2",
    "amount": "10000stake"
  }
...
{
  "@type": "/cosmos.foundation.v1beta1.ReceiveFromTreasuryAuthorization",
  "receive_limit": [
    "denom": "stake",
    "amount": "10000"
  ]

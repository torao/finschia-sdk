...
type Params struct {
	...
	FoundationTax github_com_line_lbm_sdk_types.Dec `protobuf:"bytes,2,opt,name=foundation_tax,json=foundationTax,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"foundation_tax"`
}
...
type ThresholdDecisionPolicy struct {
	...
	Threshold github_com_line_lbm_sdk_types.Dec `protobuf:"bytes,1,opt,name=threshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"threshold"`
...
type PercentageDecisionPolicy struct {
	...
	Percentage github_com_line_lbm_sdk_types.Dec `protobuf:"bytes,1,opt,name=percentage,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"percentage"`
	// windows defines the different windows for voting and execution.
	Windows *DecisionPolicyWindows `protobuf:"bytes,2,opt,name=windows,proto3" json:"windows,omitempty"`
}
...
type FoundationInfo struct {
	...
	TotalWeight github_com_line_lbm_sdk_types.Dec `protobuf:"bytes,3,opt,name=total_weight,json=totalWeight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"total_weight"`
...
type Proposal struct {
	...
	Status ProposalStatus `protobuf:"varint,6,opt,name=status,proto3,enum=cosmos.foundation.v1beta1.ProposalStatus" json:"status,omitempty"`
	// result is the final result based on the votes and election rule. Initial value is unfinalized.
	// The result is persisted so that clients can always rely on this state and not have to replicate the logic.
	Result ProposalResult `protobuf:"varint,7,opt,name=result,proto3,enum=cosmos.foundation.v1beta1.ProposalResult" json:"result,omitempty"`
	...
	ExecutorResult ProposalExecutorResult `protobuf:"varint,10,opt,name=executor_result,json=executorResult,proto3,enum=cosmos.foundation.v1beta1.ProposalExecutorResult" json:"executor_result,omitempty"`
...
type TallyResult struct {
	...
	YesCount github_com_line_lbm_sdk_types.Dec `protobuf:"bytes,1,opt,name=yes_count,json=yesCount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"yes_count"`
	// abstain_count is the sum of abstainers.
	AbstainCount github_com_line_lbm_sdk_types.Dec `protobuf:"bytes,2,opt,name=abstain_count,json=abstainCount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"abstain_count"`
	// no is the sum of no votes.
	NoCount github_com_line_lbm_sdk_types.Dec `protobuf:"bytes,3,opt,name=no_count,json=noCount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"no_count"`
	// no_with_veto_count is the sum of veto.
	NoWithVetoCount github_com_line_lbm_sdk_types.Dec `protobuf:"bytes,4,opt,name=no_with_veto_count,json=noWithVetoCount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"no_with_veto_count"`
}
...
func init() {
	proto.RegisterEnum("cosmos.foundation.v1beta1.VoteOption", VoteOption_name, VoteOption_value)
	proto.RegisterEnum("cosmos.foundation.v1beta1.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterEnum("cosmos.foundation.v1beta1.ProposalResult", ProposalResult_name, ProposalResult_value)
	proto.RegisterEnum("cosmos.foundation.v1beta1.ProposalExecutorResult", ProposalExecutorResult_name, ProposalExecutorResult_value)
	proto.RegisterType((*Params)(nil), "cosmos.foundation.v1beta1.Params")
	proto.RegisterType((*ValidatorAuth)(nil), "cosmos.foundation.v1beta1.ValidatorAuth")
	proto.RegisterType((*UpdateFoundationParamsProposal)(nil), "cosmos.foundation.v1beta1.UpdateFoundationParamsProposal")
	proto.RegisterType((*UpdateValidatorAuthsProposal)(nil), "cosmos.foundation.v1beta1.UpdateValidatorAuthsProposal")
	proto.RegisterType((*Member)(nil), "cosmos.foundation.v1beta1.Member")
	proto.RegisterType((*ThresholdDecisionPolicy)(nil), "cosmos.foundation.v1beta1.ThresholdDecisionPolicy")
	proto.RegisterType((*PercentageDecisionPolicy)(nil), "cosmos.foundation.v1beta1.PercentageDecisionPolicy")
	proto.RegisterType((*DecisionPolicyWindows)(nil), "cosmos.foundation.v1beta1.DecisionPolicyWindows")
	proto.RegisterType((*FoundationInfo)(nil), "cosmos.foundation.v1beta1.FoundationInfo")
	proto.RegisterType((*Proposal)(nil), "cosmos.foundation.v1beta1.Proposal")
	proto.RegisterType((*TallyResult)(nil), "cosmos.foundation.v1beta1.TallyResult")
	proto.RegisterType((*Vote)(nil), "cosmos.foundation.v1beta1.Vote")
}

...
func init() {
	proto.RegisterType((*GenesisState)(nil), "cosmos.foundation.v1beta1.GenesisState")
	proto.RegisterType((*GrantAuthorization)(nil), "cosmos.foundation.v1beta1.GrantAuthorization")
}

...
type FT struct {
	...
	// amount of the token
	Amount github_com_line_lbm_sdk_types.Int `protobuf:"bytes,2,opt,name=amount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"amount"`
}
...
func init() {
	...
	proto.RegisterType((*Token)(nil), "cosmos.token.v1beta1.Token")
	proto.RegisterType((*FT)(nil), "cosmos.token.v1beta1.FT")
	proto.RegisterType((*Pair)(nil), "cosmos.token.v1beta1.Pair")
	proto.RegisterType((*Grant)(nil), "cosmos.token.v1beta1.Grant")
	proto.RegisterType((*Approve)(nil), "cosmos.token.v1beta1.Approve")
}

...
func init() {
	proto.RegisterType((*EventTransfer)(nil), "cosmos.token.v1beta1.EventTransfer")
	proto.RegisterType((*EventApprove)(nil), "cosmos.token.v1beta1.EventApprove")
	proto.RegisterType((*EventIssue)(nil), "cosmos.token.v1beta1.EventIssue")
	proto.RegisterType((*EventGrant)(nil), "cosmos.token.v1beta1.EventGrant")
	proto.RegisterType((*EventRevoke)(nil), "cosmos.token.v1beta1.EventRevoke")
	proto.RegisterType((*EventMint)(nil), "cosmos.token.v1beta1.EventMint")
	proto.RegisterType((*EventBurn)(nil), "cosmos.token.v1beta1.EventBurn")
	proto.RegisterType((*EventModify)(nil), "cosmos.token.v1beta1.EventModify")
}

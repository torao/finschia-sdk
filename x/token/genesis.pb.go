...
type ClassGenesisState struct {
	...
	Nonce github_com_line_lbm_sdk_types.Uint `protobuf:"bytes,1,opt,name=nonce,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Uint" json:"nonce"`
...
func init() {
	...
	proto.RegisterType((*ClassGenesisState)(nil), "cosmos.token.v1beta1.ClassGenesisState")
	proto.RegisterType((*Balance)(nil), "cosmos.token.v1beta1.Balance")
}

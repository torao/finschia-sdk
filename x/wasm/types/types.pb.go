...
type AccessTypeParam struct {
	Value AccessType `protobuf:"varint,1,opt,name=value,proto3,enum=cosmos.wasm.v1beta1.AccessType" json:"value,omitempty" yaml:"value"`
}
...
type AccessConfig struct {
	Permission AccessType `protobuf:"varint,1,opt,name=permission,proto3,enum=cosmos.wasm.v1beta1.AccessType" json:"permission,omitempty" yaml:"permission"`
...
type Params struct {
	...
	InstantiateDefaultPermission AccessType   `protobuf:"varint,2,opt,name=instantiate_default_permission,json=instantiateDefaultPermission,proto3,enum=cosmos.wasm.v1beta1.AccessType" json:"instantiate_default_permission,omitempty" yaml:"instantiate_default_permission"`
...
type ContractInfo struct {
	...
	Status ContractStatus `protobuf:"varint,7,opt,name=status,proto3,enum=cosmos.wasm.v1beta1.ContractStatus" json:"status,omitempty"`
...
type ContractCodeHistoryEntry struct {
	Operation ContractCodeHistoryOperationType `protobuf:"varint,1,opt,name=operation,proto3,enum=cosmos.wasm.v1beta1.ContractCodeHistoryOperationType" json:"operation,omitempty"`
	// CodeID is the reference to the stored WASM code
...
type Model struct {
	...
	Key github_com_line_ostracon_libs_bytes.HexBytes `protobuf:"bytes,1,opt,name=key,proto3,casttype=github.com/tendermint/tendermint/libs/bytes.HexBytes" json:"key,omitempty"`
...
func init() {
	proto.RegisterEnum("cosmos.wasm.v1beta1.AccessType", AccessType_name, AccessType_value)
	proto.RegisterEnum("cosmos.wasm.v1beta1.ContractStatus", ContractStatus_name, ContractStatus_value)
	proto.RegisterEnum("cosmos.wasm.v1beta1.ContractCodeHistoryOperationType", ContractCodeHistoryOperationType_name, ContractCodeHistoryOperationType_value)
	proto.RegisterType((*AccessTypeParam)(nil), "cosmos.wasm.v1beta1.AccessTypeParam")
	proto.RegisterType((*AccessConfig)(nil), "cosmos.wasm.v1beta1.AccessConfig")
	proto.RegisterType((*Params)(nil), "cosmos.wasm.v1beta1.Params")
	proto.RegisterType((*CodeInfo)(nil), "cosmos.wasm.v1beta1.CodeInfo")
	proto.RegisterType((*ContractInfo)(nil), "cosmos.wasm.v1beta1.ContractInfo")
	proto.RegisterType((*ContractCodeHistoryEntry)(nil), "cosmos.wasm.v1beta1.ContractCodeHistoryEntry")
	proto.RegisterType((*AbsoluteTxPosition)(nil), "cosmos.wasm.v1beta1.AbsoluteTxPosition")
	proto.RegisterType((*Model)(nil), "cosmos.wasm.v1beta1.Model")
}

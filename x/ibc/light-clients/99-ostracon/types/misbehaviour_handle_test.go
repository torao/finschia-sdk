	...
	testCases := []struct {
	...
	}{
		{
			...
			&types.Misbehaviour{
				...
				Header2:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), height, suite.now.Add(time.Minute), bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				ClientId: chainID,
			},
			suite.now,
			true,
		},
		{
			...
			heightMinus1,
			&types.Misbehaviour{
				Header1:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now, bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				Header2:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now.Add(time.Minute), bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				ClientId: chainID,
			},
			suite.now,
			true,
		},
		{
			...
			&types.Misbehaviour{
				Header1:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now, bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				Header2:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), heightMinus3, suite.now.Add(time.Minute), bothValSet, suite.valSet, bothVoterSet, tmtypes.WrapValidatorsToVoterSet(suite.valSet.Validators), bothSigners),
				ClientId: chainID,
			},
			suite.now,
			true,
		},
		{
			...
			heightMinus3,
			&types.Misbehaviour{
				Header1:  suite.chainA.CreateOCClientHeader(chainIDRevision0, int64(height.RevisionHeight), heightMinus1, suite.now, bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				Header2:  suite.chainA.CreateOCClientHeader(chainIDRevision0, int64(height.RevisionHeight), heightMinus3, suite.now.Add(time.Minute), bothValSet, suite.valSet, bothVoterSet, tmtypes.WrapValidatorsToVoterSet(suite.valSet.Validators), bothSigners),
				ClientId: chainID,
			},
			suite.now,
			true,
		},
		{
			...
			&types.Misbehaviour{
				...
				Header2:  suite.chainA.CreateOCClientHeader(chainIDRevision0, 3, heightMinus3, suite.now.Add(time.Minute), bothValSet, suite.valSet, bothVoterSet, tmtypes.WrapValidatorsToVoterSet(suite.valSet.Validators), bothSigners),
				ClientId: chainID,
			},
			suite.now,
			true,
		},
		{
			...
			&types.Misbehaviour{
				...
				Header2:  suite.chainA.CreateOCClientHeader(chainIDRevision1, 1, heightMinus3, suite.now.Add(time.Minute), bothValSet, suite.valSet, bothVoterSet, tmtypes.WrapValidatorsToVoterSet(suite.valSet.Validators), bothSigners),
				ClientId: chainID,
			},
			suite.now,
			true,
		},
		{
			...
			height,
			&types.Misbehaviour{
				Header1:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), height, suite.now, bothValSet, suite.valSet, bothVoterSet, tmtypes.WrapValidatorsToVoterSet(suite.valSet.Validators), bothSigners),
				Header2:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), height, suite.now.Add(time.Minute), bothValSet, suite.valSet, bothVoterSet, tmtypes.WrapValidatorsToVoterSet(suite.valSet.Validators), bothSigners),
				ClientId: chainID,
			},
			suite.now,
			true,
		},
		{
			...
			height,
			&types.Misbehaviour{
				Header1:  suite.chainA.CreateOCClientHeader("ethermint", int64(height.RevisionHeight), height, suite.now, bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				Header2:  suite.chainA.CreateOCClientHeader("ethermint", int64(height.RevisionHeight), height, suite.now.Add(time.Minute), bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				ClientId: chainID,
			},
			suite.now,
			false,
		...
		},
		{
			...
			&types.Misbehaviour{
				Header1:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now, bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				Header2:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), heightMinus3, suite.now.Add(time.Minute), bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				ClientId: chainID,
			},
			suite.now,
			false,
		...
		},
		{
			...
			height,
			&types.Misbehaviour{
				Header1:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), height, suite.now, bothValSet, suite.valSet, bothVoterSet, bothVoterSet, bothSigners),
				Header2:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), height, suite.now.Add(time.Minute), bothValSet, suite.valSet, bothVoterSet, tmtypes.WrapValidatorsToVoterSet(suite.valSet.Validators), bothSigners),
				ClientId: chainID,
			},
			suite.now,
		...
		},
		{
			...
			height,
			&types.Misbehaviour{
				Header1:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), height, suite.now, altValSet, bothValSet, tmtypes.WrapValidatorsToVoterSet(altValSet.Validators), bothVoterSet, altSigners),
				Header2:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), height, suite.now.Add(time.Minute), bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				ClientId: chainID,
			},
			suite.now,
		...
		},
		{
			...
			&types.Misbehaviour{
				Header1:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), height, suite.now, bothValSet, bothValSet, bothVoterSet, bothVoterSet, bothSigners),
				Header2:  suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), height, suite.now.Add(time.Minute), altValSet, bothValSet, tmtypes.WrapValidatorsToVoterSet(altValSet.Validators), bothVoterSet, altSigners),
				ClientId: chainID,
			},
			suite.now,
			false,

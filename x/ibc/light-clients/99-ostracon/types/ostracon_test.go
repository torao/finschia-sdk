...
func (suite *TendermintTestSuite) SetupTest() {
	...
	suite.header = suite.chainA.CreateOCClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now, suite.valSet, suite.valSet, voterSet, voterSet, []tmtypes.PrivValidator{suite.privVal})

...
const (
	chainID         = "chainID"
	tmClientID0     = "99-tendermint-0"
	tmClientID1     = "99-tendermint-1"
...
func (suite *TypesTestSuite) TestValidateGenesis() {
	...
	header := suite.chainA.CreateOCClientHeader(chainID, int64(clientHeight.RevisionHeight), heightMinus1, now, valSet, valSet, voterSet, voterSet, []tmtypes.PrivValidator{privVal})

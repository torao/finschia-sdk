...
const (
	...
	Tendermint string = "99-tendermint"
...
type ClientState interface {
	...
	CheckSubstituteAndUpdateState(ctx sdk.Context, cdc codec.Codec, subjectClientStore, substituteClientStore sdk.KVStore, substituteClient ClientState, height Height) (ClientState, error)

...
import (
	...
	ostflags "github.com/tendermint/tendermint/libs/cli/flags"
	"github.com/tendermint/tendermint/libs/log"
	ostrand "github.com/tendermint/tendermint/libs/rand"
	"github.com/tendermint/tendermint/node"
	ostclient "github.com/tendermint/tendermint/rpc/client"
...
func New(t *testing.T, cfg Config) *Network {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		if cfg.EnableLogging {
			...
			logger, _ = ostflags.ParseLogLevel("info", logger, tmcfg.DefaultLogLevel)
		}

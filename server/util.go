...
import (
	...
	ostcmd "github.com/tendermint/tendermint/cmd/tendermint/commands"
	tmcfg "github.com/tendermint/tendermint/config"
	ostlog "github.com/tendermint/tendermint/libs/log"
...
func NewContext(v *viper.Viper, config *tmcfg.Config, logger ostlog.Logger) *Context {
